...
type
  TForm1 = class(TForm)
    ...
    procedure 短日志Click(Sender: TObject);
...
{$R *.fmx}
procedure TForm1.短日志Click(Sender: TObject);
begin
...
begin
PostLog(llHint,'这是一条很长的中文日志，目标是超过syslog约定的1024个字符的限制。'+
  ...
  '指薪修祜 永绥吉劭 矩步引领 俯仰廊庙 束带矜庄 徘徊瞻眺'#13#10+
  '孤陋寡闻 愚蒙等诮 谓语助者 焉哉乎也');
end;
