...
type
  ...
  protected
    ...
    procedure DoIntroSort(AParam1,AParam2:Integer);
...
implementation
uses sysutils,windows,mmdsworkers;
...
procedure TThreadSort.DoIntroSort(AParam1, AParam2: Integer);
var
  AParams:PThreadSortParam;
begin
AParams:=PThreadSortParam(AParam1);
try
...
if (not EnableThreads) or (R-L<ThreadThreshold) then
  ...
  InterlockedIncrement(FCounter);
  AddThreadWork(DoIntroSort,Integer(AParams),0);
  end;
end;
