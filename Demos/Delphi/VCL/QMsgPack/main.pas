...
try
  ...
  mmResult.Lines.Add('ItemByPath(''array[1]'')=' + AMsgPack.ItemByPath
    ('array[1]').AsString);
...
var
  v_q : TQHashedMsgPack;
begin
  v_q := TQHashedMsgPack.Create;
  v_q.Add('i1').AsInteger:=7;
  v_q.Add('a2').Add('val').AsInteger:=50;
  v_q[0].Name:='i2';
  ShowMessage(v_q[1][0].Path);
  v_q.Free;
end;
