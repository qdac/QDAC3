...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.Grids, Vcl.DBGrids, Vcl.ExtCtrls,QDB,DateUtils,
...
begin
FDest.CopyFrom(FSource,dcmCurrents,Edit1.Text);
FDest.Distinct;
end;
...
var
  ...
  AField: TField;
begin
FSource := CreateDemoDataSet(Self, 100);
