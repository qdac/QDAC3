...
begin
  ShowMessage('×Ü³É¼¨(Total Scale):'+FloatToStr(FDataSet.Sum('scale')));
end;

procedure TForm1.Button2Click(Sender: TObject);
begin
  ShowMessage('Æ½¾ù³É¼¨(Avg Scale):'+FloatToStr(FDataSet.Avg('scale')));
end;

procedure TForm1.Button3Click(Sender: TObject);
begin
  ShowMessage('ÄêÁäÖµÊýÁ¿(Age values count):'+IntToStr(FDataSet.DistinctCount('Age')));
end;

procedure TForm1.Button4Click(Sender: TObject);
begin
//Õâ¾äº¯ÊýÑÝÊ¾ÁË·Ö×é×Ö¶ÎµÄ¼Ó as À´¶¨Òå×Ö¶Î±ðÃû»òÖ±½Ó¶¨Òå×Ö¶Î±ðÃû£¬Ê¹ÓÃÄ¬ÈÏ×Ö¶ÎÃûµÄ²»Í¬Çé¿ö
